...
const StoreMetricsCard = ({ title, value, icon, change, trend }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="p-2 rounded-full bg-blue-50">{getIcon(icon)}</div>
      </div>
      ...
      <div className="mt-2 flex items-center">
        {change === null ? (
          ...
          <>
            <span className={`inline-flex items-center px-2 py-0.5 rounded text-sm ${trendIndicator.colorClass}`}>
              {trendIndicator.icon}
              <span className="ml-1">{typeof change === 'number' ? change : 0}%</span>
            </span>
